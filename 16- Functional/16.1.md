...
public class LambdaScopeExample {
    ...
    public void demonstrateLambdaScopes() {
        // Local variable in method
        int localVariable = 30;

        // Effectively final variable (not changed after assignment)
        int effectivelyFinalVariable = 40;

        // Regular final variable
        final int finalVariable = 50;

        // Lambda capturing instance, static, and effectively final local variables
        Runnable lambdaFunction = () -> {
            System.out.println("Instance variable: " + instanceVariable);

            System.out.println("Static variable: " + staticVariable);

            // Can access local variable only if it's effectively final (not modified)
            System.out.println("Local variable (effectively final): " + localVariable);
        ...
        // Uncommenting this line would cause a compilation error because 'localVariable' is no longer effectively final.
        // localVariable = 35; // Error: local variables referenced from a lambda expression must be final or effectively final
    }

    public static void main(String[] args) {
        new LambdaScopeExample().demonstrateLambdaScopes();
    }
}
